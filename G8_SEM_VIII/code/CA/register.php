...
<head>
	...
	<title>Virtual Dressing Room - Signup</title>
...
<body>
	<div class="row">
			<h2 align="center">Virtual Chartered Accountant </h2>
	<hr />
    ...
    echo $msg;
						...
						<fieldset>
							<div class="form-group">
								...
								<input class="form-control" placeholder=" Enter The Full Name" name="name" type="text" pattern="^(\w\w+)\s(\w+)\s(\w+)$" required="true">
							</div>
							<div class="form-group">
							<label>E-mail</label>
